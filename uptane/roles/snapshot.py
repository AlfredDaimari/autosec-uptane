...
import tomli
from uptane.error.snapshot import SnapshotTargetsFileHashNoMatch
...
class SnapshotOffline(TarSnapManualRole):
    ...
    def __init__(self, cfg: str,image_cfg: str, targets_metadata_file:str) -> None:
        '''
        ...
        with open(targets_metadata_file, "rb") as f:
            ...
            self.signed_dict["spec_version"] = str(OFFLINE_SNAPSHOT_SPEC_VERSION)
    ...
    def __generate_metadata(self) -> None:
        ...
        if self.signed_dict["image_hash"] != self.targets_metadata_file_dict["signed"]["image_hash"]:
            raise SnapshotTargetsFileHashNoMatch
